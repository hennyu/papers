...
for idx, run in enumerate(runs):
	...
	join("analysis/similarities", similarity_filenames[idx]), join("analysis/networks", network_filenames[idx]), join("analysis/clusters", cluster_filenames[idx]))
...
metadata_categories = ["cluster-size", "country", "narrative-perspective", "year"]
...
"analysis/clusters/clusters_3nn_cosine_mfw_1000_tfidf_HIST.csv", "mfw", 30, norm_mode="mean", rank_file="features/mfw_ranks.csv", outfile="analysis/feature_exploration/distinctiveness_mfw_HIST")
...
"analysis/clusters/clusters_3nn_cosine_mfw_1000_tfidf_SENT.csv", "mfw", 30, norm_mode="mean", rank_file="features/mfw_ranks.csv", outfile="analysis/feature_exploration/distinctiveness_mfw_SENT")

## all novels, MFW

feature_exploration.visualize_cluster_distinctiveness(wdir, "corpus_metadata/metadata.csv", "features/mfw_1000_tfidf.csv", 
"analysis/clusters/clusters_3nn_cosine_mfw_1000_tfidf.csv", "mfw", 30, norm_mode="mean", rank_file="features/mfw_ranks.csv", outfile="analysis/feature_exploration/distinctiveness_mfw")
...
"analysis/clusters/clusters_3nn_cosine_topics_100_HIST.csv", "topics", 30, norm_mode="mean", rank_file="features/topicmodel/aggregates/100tp-5000it-100in/topicRanks.csv", 
...
"analysis/clusters/clusters_3nn_cosine_topics_100_SENT.csv", "topics", 30, norm_mode="mean", rank_file="features/topicmodel/aggregates/100tp-5000it-100in/topicRanks.csv", 
...
"analysis/clusters/clusters_3nn_cosine_topics_100.csv", "topics", 30, norm_mode="mean", rank_file="features/topicmodel/aggregates/100tp-5000it-100in/topicRanks.csv", 
